...
output:
  rmarkdown::html_vignette:
    mathjax: default
vignette: |
  %\VignetteIndexEntry{OASIS Theory: Algebra and Implementation Details} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
params:
  family: red
  preset: homage
css: albers.css
...
Read this after `vignette("oasis_method")` if you want the linear algebra behind the user-facing API. The code chunks below are there to make the main scaling claims executable rather than purely narrative.
