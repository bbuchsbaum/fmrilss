...
output:
  rmarkdown::html_vignette:
    mathjax: default
vignette: |
  %\VignetteIndexEntry{Voxel-wise HRF Modeling with fmrilss} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
params:
  family: red
  preset: homage
css: albers.css
...
**Alternative approach:** For a library-constrained method that is usually faster and more stable, see `vignette("sbhm")`.
...
These metrics give you a direct accuracy check on the simulated data rather than relying on a visual impression alone.
