...
output:
  rmarkdown::html_vignette:
    mathjax: default
vignette: '%\VignetteIndexEntry{Voxel-wise HRF Modeling with fmrilss} %\VignetteEngine{knitr::rmarkdown}
...
for (v in 1:n_vox) {
  ...
  noise <- Filter(length, Reduce(
    function(prev, inn) ar_coef * prev + sqrt(1 - ar_coef^2) * inn,
    e[-1], accumulate = TRUE, init = e[1]))
  Y[, v] <- Y[, v] + unlist(noise)
}
